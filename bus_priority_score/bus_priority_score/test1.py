...
def safe_powerflow(system, timeout=5.0):
...
def optimize_powerflow(base_apparent_power=25):
    try:
        ...
        initial_voltages = {}
        for solved_node in initial_pf.nodes:
            ...
            if node:
                ...
                initial_voltages[node.uuid] = abs(solved_node.voltage)
        ...
        logging.error(f"❌ Priority score computation failed: {e}")
...
if __name__ == "__main__":
    optimize_powerflow()  # 🚀 Automatically runs on startup
